...
class ActionType(Enum):
    ...
    UPLOAD_SESSION_STARTED = "upload_session_started"
    ...
    DOWNLOAD_SESSION_STARTED = "download_session_started"
    DOWNLOAD_SESSION_EXPIRED = "download_session_expired"
    DOWNLOAD_SESSION_CANCELLED = "download_session_cancelled"
    DOWNLOAD_SESSION_COMPLETED = "download_session_completed"
